"""
Django settings for DataVizTrials project.
...
keyFile = open(os.path.join(os.path.realpath("."),"DataVizTrials/secrets.txt"), "r")
SECRET_KEY = keyFile.readline()

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['vr.uncw.edu', 'localhost', '127.0.0.1']
...
ROOT_URLCONF = 'DataVizTrials.urls'
